...
HD_PWD='D:/SSUET/INSPIRE IC DESIGN/RTL/2wacc/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_tb.tcl
